...
module.exports = class Game {
  ...
  loadStartScreen(ctx) {
    ...
    logo.onload = () => {
      ctx.drawImage(logo, 150, 100, 300, 95);
    };
    ...
    img.onload = () => {
      ctx.drawImage(img, 250, 280, 100, 100);
    };
    ctx.font = '55px VT323';
  ...
  generateLogs(log, turtles) {
    let logs = [
      new Log(log, 600, 41, 160, 38, -1, 1.5),
      new Log(turtles, 320, 81, 160, 38, -1, .5),
      new Log(turtles, 600, 81, 160, 38, -1, .5),
      new Log(log, 720, 121, 160, 38, -1, 1.5),
      new Log(log, 320, 121, 160, 38, -1, 1.5),
      new Log(turtles, 200, 161, 160, 38, -1, 1.2),
      new Log(turtles, 520, 161, 160, 38, -1, 1.2),
      new Log(log, 800, 201, 160, 38, -1, 1),
      new Log(turtles, 520, 241, 160, 38, -1, 1.2),
      new Log(turtles, 920, 241, 160, 38, -1, 1.2)
    ];
